...
import com.fizzbuzz.game.fizzBuzzGame.FizzBuzzGame;
import com.fizzbuzz.game.fizzBuzzGame.FizzBuzzGameParam;
...
public class FizzBuzzGameTest {
    ...
    @Test
    void testPlay_NagyobbMintMeddigFizz_Error() {
    ...
    @Test
    void testPlay_NagyobbMintMeddigBuzz_Error() {
        ValidatorException error = assertThrows(
            ValidatorException.class,
    ...
    private void setUpFizzBuzzGameWithStreamWriter(int numberOne, int numberTwo, int meddig) {
        fizzBuzzGame = new FizzBuzzGame(streamWriter);
        fizzBuzzGame.play(FizzBuzzGameParam.Builder.newBuilder()
                .withNumberOne(numberOne)
                .withNumberTwo(numberTwo)
                .withMeddig(meddig)
                .build());
    }
}
